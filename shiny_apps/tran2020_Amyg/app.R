...
initial[["ColumnDataPlot1"]] <- new("ColumnDataPlot", XAxis = "Column data", YAxis = "detected",
    ...
    ColorBySampleName = "amy.5161_AAACCCAAGCACGATG-1", ColorBySampleSource = "---",
...
initial[["SampleAssayPlot1"]] <- new("SampleAssayPlot", Assay = "logcounts", XAxis = "None", XAxisRowData = "ID",
    XAxisSampleName = "amy.5161_AAACCCAAGCACGATG-1", XAxisSampleSource = "---",
    XAxisSampleDynamicSource = FALSE, YAxisSampleName = "amy.5161_AAACCCAAGCACGATG-1",
    YAxisSampleSource = "ColumnDataTable1", YAxisSampleDynamicSource = TRUE,
    ColorByRowData = "ID", ColorBySampleNameAssay = "logcounts",
    ColorByFeatureNameColor = "#FF0000", ShapeByRowData = "Type",
...
initial[["ColumnDataTable1"]] <- new("ColumnDataTable", Selected = "amy.5161_AAACCCAAGCACGATG-1",
...
iSEE(sce, appTitle = "M.N. Tran et al 2020, Amyg, n = 2", initial = initial)

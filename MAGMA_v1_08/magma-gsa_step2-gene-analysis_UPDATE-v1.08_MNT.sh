#!/bin/bash
#$ -cwd
#$ -N magma-gsa_step2-gene_updated_MNT
#$ -o ./logs/magma-gsa_step2-gene_v1.08_MNT08Sep2020.o
#$ -e ./logs/magma-gsa_step2-gene_v1.08_MNT08Sep2020.e
...
$MAGMA --bfile $BFILE --gene-annot SNP_Data/Liu-etal_Addiction_AgeofInitiation_10xPilotGenes.genes.annot --pval ../MAGMA/GWAS_Results/AgeofInitiation.txt use=RSID,PVALUE ncol=N --gene-model ${model} --out SNP_Data/Liu-etal_Addiction_AgeofInitiation_10xPilotGenes_${model}

$MAGMA --bfile $BFILE --gene-annot SNP_Data/Liu-etal_Addiction_CigarettesPerDay_10xPilotGenes.genes.annot --pval ../MAGMA/GWAS_Results/CigarettesPerDay.txt use=RSID,PVALUE ncol=N --gene-model ${model} --out SNP_Data/Liu-etal_Addiction_CigarettesPerDay_10xPilotGenes_${model}

$MAGMA --bfile $BFILE --gene-annot SNP_Data/Liu-etal_Addiction_DrinksPerWeek_10xPilotGenes.genes.annot --pval ../MAGMA/GWAS_Results/DrinksPerWeek.txt use=RSID,PVALUE ncol=N --gene-model ${model} --out SNP_Data/Liu-etal_Addiction_DrinksPerWeek_10xPilotGenes_${model}

$MAGMA --bfile $BFILE --gene-annot SNP_Data/Liu-etal_Addiction_SmokingCessation_10xPilotGenes.genes.annot --pval ../MAGMA/GWAS_Results/SmokingCessation.txt use=RSID,PVALUE ncol=N --gene-model ${model} --out SNP_Data/Liu-etal_Addiction_SmokingCessation_10xPilotGenes_${model}

$MAGMA --bfile $BFILE --gene-annot SNP_Data/Liu-etal_Addiction_SmokingInitiation_10xPilotGenes.genes.annot --pval ../MAGMA/GWAS_Results/SmokingInitiation.txt use=RSID,PVALUE ncol=N --gene-model ${model} --out SNP_Data/Liu-etal_Addiction_SmokingInitiation_10xPilotGenes_${model}

## 'Negative control': Meta-GWAS for CAD (CARDIoGRAM+C4D)
$MAGMA --bfile $BFILE --gene-annot SNP_Data/CoronaryArteryDisease_2015_10xPilotGenes.genes.annot --pval ../MAGMA/GWAS_Results/CoronaryArteryDisease_Nikpay2015_MNTaddn.txt use=markername,p_dgc ncol=N_estim_mnt --gene-model ${model} --out SNP_Data/CoronaryArteryDisease_10xPilotGenes_${model}
